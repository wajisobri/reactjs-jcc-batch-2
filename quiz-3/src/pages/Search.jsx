...
export const Search = () => {
    ...
    useEffect(() => {
        ...
        if(params.valueOfSearch !== undefined) {
            setSearch(params.valueOfSearch)
        }
    }, [params.valueOfSearch, setSearch, setMobileAppList])
